...
<head>
  ...
  <style>
    ...
    .bgimg {
      background-image: url('https://storage.googleapis.com/be-a-man-4-assets/hawk-snakes-bg.png');
      min-height: 100%;
...
<body>
  <div class="bgimg w3-display-container w3-animate-opacity w3-text-white">
    ...
    <div class="w3-display-right w3-center">
      <iframe src="https://storage.googleapis.com/be-a-man-4-assets/Fantasy-Crystal-Castle-resized.png"
              width="359"
              height="539"
