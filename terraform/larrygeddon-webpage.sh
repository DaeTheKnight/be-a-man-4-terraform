...
<head>
  ...
  <style>
    ...
    .bgimg {
      background-image: url('https://storage.googleapis.com/larrygeddon-assets-1/fire-bg.gif');
      min-height: 100%;
...
<body>
  <div class="bgimg w3-display-container w3-animate-opacity w3-text-white">
    ...
    <div class="w3-display-middle w3-center">
      <iframe src="https://storage.googleapis.com/larrygeddon-assets-1/devops-teacher-figure-2-tea-in-china-3.png"
              width="359"
              height="539"
    ...
    <div class="w3-display-bottomleft w3-padding-small transparent-background outlined-text">
      ...
      <p>I Dae Britt thank you Theo and Beron</p>
